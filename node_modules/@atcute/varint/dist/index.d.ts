 ...
 */
export declare const encode: (num: number, buf: number[] | Uint8Array<ArrayBufferLike>, offset?: number) => number;
/**
 * Decodes a varint
 ...
 */
export declare const decode: (buf: number[] | Uint8Array<ArrayBufferLike>, offset?: number) => [num: number, read: number];
/**
